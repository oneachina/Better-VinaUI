...
namespace VertexUI {
	...
	public:
		...
		int BtnHoverMode = 0; //0:�ײ���ɫ | 1:������ɫ | 2:���彥��
	...
	{
		wchar_t a[128];
		swprintf_s(a, L"%f", f);  // ʹ��swprintf_s��floatת��Ϊ���ַ��ַ���
		OutputDebugString(a);
		OutputDebugString(L"\n");
		return;
	}
